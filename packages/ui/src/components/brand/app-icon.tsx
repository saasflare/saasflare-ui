 ...
 */
export const AppIcon = React.forwardRef<SVGSVGElement, AppIconProps>((_props, _ref) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 316.82 275.02" fill="currentColor">
