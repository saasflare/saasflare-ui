// @toreview
/**
 * @fileoverview Combobox primitive — searchable dropdown built on Base UI Combobox.
 * Combines an input with a filterable option list, supporting single selection,
 * clear button, and grouped options. Part of the Saasflare base component layer.
 * @module packages/core/components/ui/combobox
 * @layer core
 *
 * @component
 * @example
 * import { Combobox, ComboboxInput, ComboboxOption } from '@saasflare/core';
 * <Combobox>
